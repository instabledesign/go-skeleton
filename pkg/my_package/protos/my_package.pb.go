...
func (Document_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_my_package_aaf4eff7c39eaed3, []int{4, 0}
}
...
func (*StoreRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_my_package_aaf4eff7c39eaed3, []int{0}
}
...
func (*StoreResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_my_package_aaf4eff7c39eaed3, []int{1}
}
...
func (*FindRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_my_package_aaf4eff7c39eaed3, []int{2}
}
...
func (*FindResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_my_package_aaf4eff7c39eaed3, []int{3}
}
...
func (*Document) Descriptor() ([]byte, []int) {
	return fileDescriptor_my_package_aaf4eff7c39eaed3, []int{4}
}
...
func init() { proto.RegisterFile("my_package.proto", fileDescriptor_my_package_aaf4eff7c39eaed3) }

var fileDescriptor_my_package_aaf4eff7c39eaed3 = []byte{
